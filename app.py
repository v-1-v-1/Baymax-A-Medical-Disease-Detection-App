...
def resultc():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            return render_template('resultc.html', filename=filename, fn=fullname, age=age, r=pred, gender=gender)
...
def resultbt():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            return render_template('resultbt.html', filename=filename, fn=fullname, age=age, r=pred, gender=gender)
...
def resultd():
    if request.method == 'POST':
        ...
        return render_template('resultd.html', fn=fullname, age=age, r=pred, gender=gender)
...
def resultbc():
    if request.method == 'POST':
        ...
        return render_template('resultbc.html', fn=fullname, age=age, r=pred)
...
def resulta():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            return render_template('resulta.html', filename=filename, fn=fullname, age=age, r=pred, gender=gender)
    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            if pred < 0.5:
                ...
                pred = 1
            # pb.push_sms(pb.devices[0],str(phone), 'Hello {},\nYour COVID-19 test results are ready.\nRESULT: {}'.format(firstname,['POSITIVE','NEGATIVE'][pred]))
            return render_template('resultp.html', filename=filename, fn=fullname, age=age, r=pred, gender=gender)
...
def resulth():
    if request.method == 'POST':
        ...
        # pb.push_sms(pb.devices[0],str(phone), 'Hello {},\nYour Diabetes test results are ready.\nRESULT: {}'.format(firstname,['NEGATIVE','POSITIVE'][pred]))
        return render_template('resulth.html', fn=fullname, age=age, r=pred, gender=gender)
